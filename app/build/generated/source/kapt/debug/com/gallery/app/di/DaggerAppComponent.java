...
import com.gallery.app.data.di.DatabaseModule;
import com.gallery.app.data.di.DatabaseModule_ProvideCartDatabaseFactory;
import com.gallery.app.data.di.NetworkModule;
import com.gallery.app.data.di.NetworkModule_ProvideCartApiServiceFactory;
import com.gallery.app.data.di.NetworkModule_ProvideGsonFactory;
import com.gallery.app.data.di.NetworkModule_ProvideOkHttpClientFactory;
import com.gallery.app.data.di.NetworkModule_ProvideRetrofitFactory;
import com.gallery.app.data.service.ApiService;
import com.gallery.app.data.service.UserRepositoryImpl_Factory;
import com.gallery.app.domain.interactor.EmailValidationUseCase_Factory;
import com.gallery.app.domain.interactor.FetchItemListUseCase_Factory;
import com.gallery.app.domain.interactor.GetItemsUseCase_Factory;
import com.gallery.app.domain.interactor.SaveItemsUseCase_Factory;
...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Provider<UserDatabse> provideCartDatabaseProvider;
  ...
  private Provider<ApiService> provideCartApiServiceProvider;

  private UserRepositoryImpl_Factory userRepositoryImplProvider;

  private Provider<UserRepository> provideUserRepositoryProvider;

  private EmailValidationUseCase_Factory emailValidationUseCaseProvider;

  private UserViewModel_Factory userViewModelProvider;

  private GetItemsUseCase_Factory getItemsUseCaseProvider;

  private FetchItemListUseCase_Factory fetchItemListUseCaseProvider;

  private SaveItemsUseCase_Factory saveItemsUseCaseProvider;
  ...
  private void initialize(final Builder builder) {
    ...
    this.provideCartDatabaseProvider =
        DoubleCheck.provider(
            DatabaseModule_ProvideCartDatabaseFactory.create(
                builder.databaseModule, (Provider) applicationProvider));
    this.provideOkHttpClientProvider =
        NetworkModule_ProvideOkHttpClientFactory.create(
            builder.networkModule, (Provider) applicationProvider);
    ...
    this.provideCartApiServiceProvider =
        DoubleCheck.provider(
            NetworkModule_ProvideCartApiServiceFactory.create(
                builder.networkModule, provideRetrofitProvider));
    this.userRepositoryImplProvider =
        UserRepositoryImpl_Factory.create(
            provideCartDatabaseProvider,
            provideCartApiServiceProvider,
            SchedulersFacade_Factory.create());
    this.provideUserRepositoryProvider =
        DoubleCheck.provider((Provider) userRepositoryImplProvider);
    this.emailValidationUseCaseProvider =
        EmailValidationUseCase_Factory.create(
            SchedulersFacade_Factory.create(), provideUserRepositoryProvider);
    this.userViewModelProvider =
        UserViewModel_Factory.create(
            SchedulersFacade_Factory.create(), emailValidationUseCaseProvider);
    this.getItemsUseCaseProvider = GetItemsUseCase_Factory.create(provideUserRepositoryProvider);
    this.fetchItemListUseCaseProvider =
        FetchItemListUseCase_Factory.create(provideUserRepositoryProvider);
    this.saveItemsUseCaseProvider = SaveItemsUseCase_Factory.create(provideUserRepositoryProvider);
    this.userDetailsViewModelProvider =
        UserDetailsViewModel_Factory.create(
